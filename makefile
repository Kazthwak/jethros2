...
program.tar: tardir makefile
	@tar --transform 's|^\./||' -cf program.tar -C tardir .

boot.o: ./code/boot.s
	@~/opt/cross/bin/i686-elf-as ./code/boot.s -o boot.o

kernel.o: kernel.c headers.h ./c/drivers.c ./c/files.h ./c/gdt.c ./c/headers.h ./c/idt.c ./c/utils.c ./c/graphics.c ./c/interupts.c ./c/keyboard.c ./c/disk.c ./c/timer.c ./c/debug.c ./c/mem.c
